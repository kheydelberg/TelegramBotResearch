...
from core.handlers.basic import get_inline, get_photo
from core.handlers.callback import get_contact, get_geo
...
async def start():
    ...
    # dp.callback_query.register(select_btn, F.data == 'geo')
    # dp.callback_query.register(select_btn, F.data == 'contact')
